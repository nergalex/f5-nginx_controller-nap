...
class AzureRMVirtualMachineScaleSetVMInfo(AzureRMModuleBase):
    ...
    def get(self):
        # https://docs.microsoft.com/fr-fr/python/api/azure-mgmt-compute/azure.mgmt.compute.v2019_12_01.models.virtualmachinescalesetvm?view=azure-python
        response = None
        results = []
        try:
    ...
    def format_response(self, item):
        ...
        d = {
            ...
            'scale_in_policy': d.get('scale_in_policy', None),
            ...
            'network_profile': d.get('network_profile', None),
            'network_interfaces': d.get('network_profile').get('network_interfaces', None),
            'network_profile_configuration': d.get('network_profile_configuration', None),
            'network_interface_configurations': d.get('network_profile').get('network_interface_configurations', None),
        }
        return d
